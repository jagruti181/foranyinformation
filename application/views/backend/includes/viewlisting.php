	...
	<div class="col-lg-12">
		...
		<script>
            function drawtable(resultrow) {
                ...
                return "<tr><td>" + resultrow.id + "</td><td>" + resultrow.name + "</td><td>" + resultrow.address + "</td><td>" + resultrow.email + "</td><td>" + resultrow.contactno + "</td><td>" + resultrow.pointer + "</td><td><a class='btn btn-primary btn-xs' href='<?php echo site_url('site/editlisting?id=');?>"+resultrow.id +"'><i class='icon-pencil'></i></a><a class='btn btn-danger btn-xs' href='<?php echo site_url('site/deletelisting?id='); ?>"+resultrow.id +"'><i class='icon-trash '></i></a></td><tr>";
            }
